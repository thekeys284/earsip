          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                   ...
                   <input type="text" class="form-control" id="nama_seksi">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="recipient-name" class="col-form-label">Alternatif Email : </label>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                   <label for="recipient-name" class="col-form-label">Nama Seksi : </label>
                   <input type="text" class="form-control" id="edit_nama_seksi">
                </div>
                <div class="form-group">
                    <label for="recipient-name" class="col-form-label">Singkatan : </label>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                   <label for="recipient-name" class="col-form-label">Nama Seksi : </label>
                   <input type="text" class="form-control" id="view_nama_seksi">
                </div>
                <div class="form-group">
                    <label for="recipient-name" class="col-form-label">Singkatan : </label>
                    <input type="text" class="form-control" id="view_singkatan">
                </div>
                <div class="form-group">
                   <label for="recipient-name" class="col-form-label">Kode Seksi : </label>
                   <input type="number" class="form-control" id="view_kode_seksi">
                </div>
                <div class="form-group">
                    <label for="recipient-name" class="col-form-label">Kode Bidang : </label>
                    <input type="number" class="form-control" id="view_kode_bidang">
                </div>
                <div class="form-group">
                   <label for="recipient-name" class="col-form-label">Kode Satuan Kerja : </label>
                   <input type="number" class="form-control" id="view_kode_satker">
                </div>
                <div class="form-group">
                    <label for="recipient-name" class="col-form-label">Kode Bidang : </label>
                    <input type="number" class="form-control" id="view_kode_bidang">
